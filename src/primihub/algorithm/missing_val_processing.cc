      ...
      if (iter->second == 1 || iter->second == 3) {
            ...
            for (int k = 0; k < chunk_num; k++) {
              ...
              for (int64_t j = 0; j < str_array->length(); j++) {
                ...
                if (ret != 0) {
                  ...
                  max = i64_val>max? i64_val:max;
                  min = i64_val<min? i64_val:min;
                  int_sum += i64_val;
                }
              }
            ...
            for (int k = 0; k < chunk_num; k++) {
              ...
              for (int64_t j = 0; j < str_array->length(); j++) {
                ...
                if (ret) {
                  ...
                  max = d_val>max? d_val:max;
                  min = d_val<min? d_val:min;
                  double_sum += d_val;
                }
              }
        ...
        if (iter->second == 1 || iter->second == 3) {
          ...
          if(party_id_!=2){
            ...
            mpc_exec->MPC_Compare(empty, sh_res);
          }
